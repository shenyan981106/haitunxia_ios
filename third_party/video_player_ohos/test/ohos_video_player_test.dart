...
void main() {
  ...
  group('OhosVideoPlayer', () {
    ...
    test('dispose', () async {
      ...
      verify(api.dispose(TextureMessage(textureId: 1)));
    });
    ...
    test('setLooping', () async {
      ...
      verify(playerApi.setLooping(LoopingMessage(textureId: 1, isLooping: true)));
    });
    ...
    test('play', () async {
      ...
      verify(playerApi.play(TextureMessage(textureId: 1)));
    });
    ...
    test('pause', () async {
      ...
      verify(playerApi.pause(TextureMessage(textureId: 1)));
    });
    ...
    group('setMixWithOthers', () {
      test('passes true', () async {
        ...
        verify(api.setMixWithOthers(MixWithOthersMessage(mixWithOthers: true)));
      });
      ...
      test('passes false', () async {
        ...
        verify(api.setMixWithOthers(MixWithOthersMessage(mixWithOthers: false)));
      });
    });
    ...
    test('setVolume', () async {
      ...
      await player.setVolume(1, volume);
            ...
            verify(playerApi.setVolume(VolumeMessage(textureId: 1, volume: volume)));
    });
    ...
    test('setPlaybackSpeed', () async {
      ...
      await player.setPlaybackSpeed(1, speed);
            ...
            verify(playerApi.setPlaybackSpeed(PlaybackSpeedMessage(textureId: 1, speed: speed)));
    });
    ...
    test('seekTo', () async {
      ...
      verify(playerApi.seekTo(PositionMessage(textureId: 1, position: positionMilliseconds)));
    });
    ...
    test('getPosition', () async {
      ...
      const positionMilliseconds = 12345;
      when(
        playerApi.position(TextureMessage(textureId: 1)),
      ).thenAnswer((_) async => PositionMessage(textureId: 1, position: positionMilliseconds));
